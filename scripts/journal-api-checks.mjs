...
export async function checkJournal(mf,key,otherKey) {
  ...
  try{
    ...
    original.method='pole';original.survey={id:randomUUID(),name:'Fältpass',vessel:'Scilla',area:'Roxen',waterLevel:33.4,referenceLevel:33,reference:'RH00'};
    ...
    assert.deepEqual(final.event.survey,original.survey);assert.equal(final.event.method,'pole');
